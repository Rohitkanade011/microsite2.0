...
<section class="section shadow-sm">
	...
	<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
	  <li class="nav-item ami-tab-link">
	    <a class="nav-link text-uppercase ami-tab active" id="pills-external-ami" data-toggle="pill" href="#external-ami" role="tab" aria-controls="external-ami" aria-selected="true">External<span class="d-none d-md-inline"> Amenities</span></a>
	  </li>
	  <li class="nav-item ami-tab-link">
	    <a class="nav-link text-uppercase ami-tab" id="pills-internal-ami" data-toggle="pill" href="#internal-ami" role="tab" aria-controls="internal-ami" aria-selected="false">Internal<span class="d-none d-md-inline"> Amenities</span></a>
	  </li>
	</ul>
	<div class="tab-content" id="pills-tabContent">
	  <?php include "./design/amenities/amenities-".$amiStyle.".php"; ?>
	</div>
</section>
...
<section class="section shadow-sm">
	...
	<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
	  <li class="nav-item">
	    <a class="nav-link text-uppercase ami-tab active" id="pills-gal-1" data-toggle="pill" href="#gal-1" role="tab" aria-controls="gal-1" aria-selected="true">Gallry 1</a>
	  </li>
	  <li class="nav-item">
	    <a class="nav-link text-uppercase ami-tab" id="pills-gal-2" data-toggle="pill" href="#gal-2" role="tab" aria-controls="gal-2" aria-selected="false">Gallry 2</a>
	  </li>
	</ul>
	<div class="tab-content" id="pills-tabContent">
	  <?php include "./design/gallery/gallery-".$galStyle.".php"; ?>
	</div>
</section>
...
<section class="section shadow-sm lazyload"
	...
	<div class="row mb-3">
		<div class="col-md-7 col-sm-12">
			...
			<iframe frameborder="0"
			class="lazyload lmap mb-2"
		    allowfullscreen=""
		    sandbox="allow-forms allow-scripts allow-pointer-lock allow-same-origin allow-top-navigation"
		    data-src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d30159.270664174754!2d72.910442!3d19.111655!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x3024f410ac19b179!2sShapoorji%20Pallonji%20Vicinia%20Powai!5e0!3m2!1sen!2sin!4v1587324502316!5m2!1sen!2sin"></iframe>
		</div>
	...
	<p>
		Shapoorji Pallonjis Vicinia, located at the centre of prominent landmarks, is unarguable the most coveted address of the suburbs. Equidistant from the the Eastern and western suburbs the project lies in close proximity to schools, malls, hospitals, highways and the rest of the city
	</p>
	<ul class="nav nav-pills mt-4 mb-3" id="pills-tab" role="tablist">
	  <li class="nav-item loc-tab-link">
	    <a class="nav-link text-uppercase ami-tab active" id="pills-loc-1" data-toggle="pill" href="#loc-1" role="tab" aria-controls="loc-1" aria-selected="true">Connectivity</a>
	  </li>
	  <li class="nav-item loc-tab-link">
	    <a class="nav-link text-uppercase ami-tab" id="pills-loc-2" data-toggle="pill" href="#loc-2" role="tab" aria-controls="loc-2" aria-selected="false">School & Colleges</a>
	  </li>
	  <li class="nav-item loc-tab-link">
	    <a class="nav-link text-uppercase ami-tab" id="pills-loc-3" data-toggle="pill" href="#loc-3" role="tab" aria-controls="loc-3" aria-selected="false">Social Infrastructure</a>
	  </li>
	</ul>
	<div class="tab-content" id="pills-tabContent">
		...
		<div class="tab-pane fade" id="loc-3" role="tabpanel" aria-labelledby="pills-loc-3">
			In close proximity of renowned Hospitals such as Hiranandani Hospital, Seven Hills Hospital, etc. and Haiko Mall, D Mart, R- City mall, Restaurants, Banks & ATMs
		</div>
	</div>
</section>
...
<section class="section shadow-sm">
	...
	<div class="at-property-item my-2 pt-md-0">
        ...
        <span class="d-block text-capitalize text-center d-sm-block d-md-none pt-2">Shapoorji Vicinia At Chandivali Powai, Mumbai</span>
